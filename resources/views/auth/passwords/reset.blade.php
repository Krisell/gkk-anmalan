        ...
        <div class="bg-white py-8 px-4 shadow-sm sm:rounded-lg sm:px-10">
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="rounded-md shadow-xs">
                    <div>
                        <input aria-label="Epost" name="email" type="email" value="{{ $email ?? old('email') }}" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-hidden focus:shadow-outline-blue focus:border-blue-300 focus:z-10 sm:text-sm sm:leading-5" placeholder="Epost">
                    </div>
                    <div class="-mt-px">
