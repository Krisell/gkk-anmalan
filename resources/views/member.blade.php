        ...
        <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8">
          <div>
            <div class="md:max-w-xl lg:max-w-3xl xl:max-w-none">
                ...
                <div class="mt-8">
                  <h2 class="text-xl font-extrabold tracking-tight-mb-2">Avgifter (notera att SSF har höjt licensavgiften för 2026)</h2>
                  <p class="text-xl leading-normal text-gray-500 mt-4">
                    <div class="text-xl leading-normal text-gray-500"><b>Medlemsavgift (inkl träningsavgift):</b> 1500 kr per år för seniorer, 700 kr per år för studerande, ungdom/junior (upp till året man fyller 23) och för pensionärer. Medlemsavgiften inkluderar en träningsavgift och ger tillgång till föreningens lokal och utrustning, men entré till Friskis krävs också, se nedan.</div>
                    <div class="text-xl leading-normal text-gray-500 mt-2"><b>Avgift för tävlingslicens 2026:</b> För ungdomar (året man fyller 18): 300kr, för övriga 1050 kr per år. Denna avgift betalas endast om man vill tävla och faktura skickas ut i samband med årets första tävling. <b>Under 2025 har GKK beslutat att subventionera tävlingslicensen för alla upp till 25 år med 300 kr.</b></div>
