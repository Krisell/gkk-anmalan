        ...
        <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8">
          <div class="space-y-12">
            <div class="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                ...
                <p class="text-xl text-gray-500">I styrkelyft tävlar man i grenarna knäböj, bänkpress och marklyft. Man kan också tävla i enbart bänkpress. Det finns tävlingar där särskild utrustning, exempelvis knälindor och böjdräkt, är tillåtet, och det finns tävlingar i så kallad "klassisk styrkelyft" där ingen hjälpande utrustning utöver knävärmare och handledslindor är tillåtet. Den klassiska grenen har flest utövare och är en lämplig utgångpunkt för en nybörjare.</p>
                <p class="text-xl text-gray-500">Här kan det vara lämpligt att visa bilder/filmer på de tre lyften?</p>
                <p class="text-xl text-gray-500">Vill man kanske nämna något om idrottens historia?</p>
                <p class="text-xl text-gray-500">Den nuvarande hemsidans information om hur en tävling går till kanske kan placeras här, alternativt som ett separat dokument?</p>
            </div>
