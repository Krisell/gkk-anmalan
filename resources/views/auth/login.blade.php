      ...
      <form action="/login" method="POST">
        ...
        <div class="mt-6 flex items-center justify-between">
          <div class="text-sm leading-5 mx-auto">
            <a href="/password/reset" class="font-medium text-gkk hover:text-indigo-500 focus:outline-hidden focus:underline transition ease-in-out duration-150">
              Glömt ditt lösenord?
            </a>
          </div>
        </div>
