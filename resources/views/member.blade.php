            ...
            <div class="md:max-w-xl lg:max-w-3xl xl:max-w-none">
                ...
                <div class="mt-8">
                  ...
                  <p class="text-xl leading-normal text-gray-500 mt-4">
                    ...
                    <div class="text-xl leading-normal text-gray-500 mt-2"><b>Avgift för tävlingslicens:</b> För ungdomar (året man fyller 18): 200kr, för övriga 700 kr per år. Denna avgift betalas endast om man vill tävla och i samband med sin första tävling (föreningen skickar ut faktura efter tävlingen).</div>
